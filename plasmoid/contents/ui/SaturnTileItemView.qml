...
Rectangle {
    ...
    property color gradientBottomColor: Qt.darker(appObj.backgroundColor, 3.0)
    ...
    readonly property int tileLabelAlignment: plasmoid.configuration.tileLabelAlignment
	...
	PlasmaComponents3.Label {
		...
		style: Text.Normal
		color: tileItemView.gradientBottomColor
	}
